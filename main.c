...
{       int ch;
	...
	pos;ln pos;
		...
		{       case 1:startgame();break;
			...
			case 0:system("cls");gotoxy(17,10);printf("#This Game is created by Prakhar sahu");delay(1000);exit(1);
			default:main();
		}
...
rectangle(0,0,70,15);
	...
	{     if(level==1)   
		...
		switch(ch)
		{
		      ...
		      case 2:main();break;
		      case 3:system("cls");gotoxy(17,10);printf("#This Game is created by Prakhar :) ");delay(1000);exit(1);
